...
np.save("npy/T_XS_from_BOOM_mape.npy",np.array(curve_mape))
np.save("npy/T_XS_from_BOOM_r.npy",np.array(curve_r))
...
np.save("npy/T_BOOM_from_XS_mape.npy",np.array(curve_mape))
np.save("npy/T_BOOM_from_XS_r.npy",np.array(curve_r))